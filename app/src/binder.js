...
module.exports = function() {
    this.configBinder = new Binder.PropertyAccessor({})

    this.config_set = function (key, value) {
        this.configBinder.set(key, value);
    };

    this.config_get = function (key, value) {
        return this.configBinder.get(key);
    };
};